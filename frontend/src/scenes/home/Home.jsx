...
import FrequentQuestion from "../../component/faq"
                    ...
                    <article>
                        ...
                        <section className="section hero has-bg-image" aria-label="home"
                            ...
                            <div className="container">
                                <div className="hero-content" data-aos="fade-right" data-aos-offset="200"
                                     data-aos-duration="1000">
                                    <h1 className="h1 section-title">
                                        The Best Website for students to <span className="span" data-aos="zoom-in"
                                                                               data-aos-delay="500">Search</span> for
                                        Software Resources.
                                    </h1>
                                    <p className="hero-text">
                                        Hello future engineers!<br/>Welcome to <b>Resourcio Community</b>!! A one-stop hub
                                        for all your
                            ...
                            <div className="container">
                                <div className="about-content">
                                    ...
                                    <h3 className="h2 section-title" data-aos="fade-right" data-aos-duration="500">
                                        A group of enthusiastic <span className="span" data-aos="zoom-in"
                                                                      data-aos-delay="500">Engineers keen to</span> help
                                        their fellow Engineers.
                                    </h3>
                                    <p className="section-text" style={{"color": "var(--gray-web)"}}>
                                        Through Resourcio we have tried to bring in different resources related to software
                                        development and
                                        other
                                        different fields related to software engineering in a single place. We want to
                                        provide students a single platform where
                                        they
                                        can find all new resources and they don't need to browse the web extensively for
                                        learning them.
                                    </p>
                        ...
                        <section className="video has-bg-image" aria-label="video"
                            ...
                            <div className="container">
                                <div className="video-card">
                                    ...
                                    <img src={shape2} width={158} height={174} loading="lazy"
                                         className="shape video-shape-2" alt="background shape"/>
                                </div>
                            </div>
                        </section>
