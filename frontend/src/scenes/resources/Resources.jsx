...
const Resources = () => {
  return (
    <div className='resources'>
      ...
      <div className="box">
        <img src={webdev} alt="Web Development" className='image' />
      ...
      <div className="box">
        <img src={appdev} className='image' />
      ...
      <div className="box lang">
        <img src={prog} className='image' />
        <h2>Programming Languages</h2>
        <p>A programming language is a system of notation for writing computer programs.</p>
        <a href='/proglang' target="_blank">
          <button> Learn More...<ion-icon name="book-outline"></ion-icon></button>
        </a>
      </div>
      <div className="box">
        <img src={devops} className='image' />
        <h2>DevOps</h2>
