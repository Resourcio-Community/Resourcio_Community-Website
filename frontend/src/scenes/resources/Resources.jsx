...
const Resources = () => {
  ...
  return (
    <div className='resources'>
      ...
      <div className="resources_h1"><h1>
      RESOURCES
        
 
  </h1></div>
  <ArrowBackIcon className="back_button" onClick={() => history.push("/")} style={{ height: 30, width: 30, touchAction: true,position:'absolute',top:'10px',color:'white'}} />
