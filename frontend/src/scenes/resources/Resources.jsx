    ...
    <div className="resources">
      ...
      <div className="card_container">
        <ResourceCard
          ...
          content="Web development is the work involved in developing a website"
          full_content=" for the Internet or an intranet."
        ...
        <ResourceCard
          image={aiml}
          title="AI/ML"
          content="AI/ML—short for artificial intelligence (AI) and machine learning (ML)—represents an important evolution "
          full_content="in computer science and data processing that is quickly transforming a vast array of industries."
          button="Read More &raquo;"
        ...
        <ResourceCard
          ...
          content="Computer security, cybersecurity, or information technology security is the protection of computer systems"
          full_content=" and networks from attacks by malicious actors."
          button="Read More &raquo;"
        ...
        <ResourceCard
          ...
          content="A blockchain is a type of distributed ledger technology (DLT) that consists of growing lists of records, "
          full_content="called blocks, that are securely linked together using cryptography. Each block contains a cryptographic hash of the previous block, a timestamp, and transaction data. The timestamp proves that the transaction data existed when the block was created."
          button="Read More &raquo;"
        ...
        <ResourceCard
          ...
          content="Competitive programming is solving well-defined problems by writing computer programs under "
          full_content="specified limits. Each problem has some specifications which need to be satisfied to solve the problem. The participants (known as competitive programmers) are required to solve these problems by writing efficient code."
          button="Read More &raquo;"
        ...
        <ResourceCard
          image={hackathon}
          title="Hackathon"
          content="Hacking is creative problem-solving. A hackathon is any event of any duration where people come together to solve"
          full_content="problems. Participants typically form groups of about 2-5 individuals, take out their laptops, and dive into problems. Training workshops are a great parallel track, especially for newcomers but also for all participants."
          button="Read More &raquo;"
        ...
        <ResourceCard
          image={os}
          title="Open-Source"
          content="Open source is a term that originally referred to open source software (OSS). OSS is software that is distributed with"
